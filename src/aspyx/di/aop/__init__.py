...
**Example**: all method executions of methods named "foo" will include an before aspect, that will be executed before the original method
...
Note, that this requires, that both the advice as well as the targeted methods need to be managed by an environment.
"""
